...
{
	TIM_HandleTypeDef *htim_motor_X=&htim3;
	TIM_HandleTypeDef *htim_motor_Y=&htim2;
  /* Set the Capture Compare4 Register value */
  htim_motor_Y->Instance->CCR1=DR1;
	htim_motor_Y->Instance->CCR2=DR4;
	htim_motor_X->Instance->CCR3=DR1;
	htim_motor_X->Instance->CCR4=DR4;
}
