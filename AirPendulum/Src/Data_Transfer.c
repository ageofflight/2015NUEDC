...
//	__IO int16_t rc_value_temp;
	...
	if(*(data_buf+2)==0X10)								//PID1
	{
			...
			PID_Z_Struct.Kp = (float)((int16_t)(*(data_buf+16)<<8)|*(data_buf+17))/10;
			PID_Z_Struct.Ti = (float)((int16_t)(*(data_buf+18)<<8)|*(data_buf+19))/100;
			PID_Z_Struct.Td = (float)((int16_t)(*(data_buf+20)<<8)|*(data_buf+21))/100;
			Data_Send_Check(sum);
	}
